define(["exports"], function(e) {
  ...
  var n = (function(e) {
    ...
    T = { year: v, month: p, day: v, weekday: p },
    S = { year: v, month: g, day: v },
    b = { year: v, month: g, day: v, weekday: g },
    O = { hour: v, minute: v },
    M = { hour: v, minute: v, second: v },
    E = { hour: v, minute: v, second: v, timeZoneName: p },
    N = { hour: v, minute: v, second: v, timeZoneName: g },
    D = { hour: v, minute: v, hour12: !1 },
    C = { hour: v, minute: v, second: v, hour12: !1 },
    F = { hour: v, minute: v, second: v, hour12: !1, timeZoneName: p },
    x = { hour: v, minute: v, second: v, hour12: !1, timeZoneName: g },
  ...
  function ne(e, t) {
    if ((void 0 === t && (t = 2), e.toString().length < t)) {
  ...
  var Se = /[A-Za-z_+-]{1,256}(:?\/[A-Za-z_+-]{1,256}(\/[A-Za-z_+-]{1,256})?)?/;
  function be(e) {
      ...
      return (
        ...
        (e.offset = function(e) {
          var t,
            ...
            s = ((a = this.name),
            We[a] ||
              (We[a] = new Intl.DateTimeFormat("en-US", {
                hour12: !1,
                timeZone: a,
                year: "numeric",
                month: "2-digit",
  ...
  var Tt = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/,
    ...
    bt = RegExp("" + St.source + Tt.source + "?"),
    Ot = RegExp("(?:T" + bt.source + ")?"),
    Mt = kt("weekYear", "weekNumber", "weekDay"),
    Et = kt("year", "ordinal"),
    Nt = RegExp(St.source + " ?(?:" + Tt.source + "|(" + Se.source + "))?"),
    Dt = RegExp("(?: " + Nt.source + ")?");
  function It(e, t, n) {
    var r = e[t];
    return P(r) ? n : ie(r);
  ...
  var xt = /^-?P(?:(?:(-?\d{1,9})Y)?(?:(-?\d{1,9})M)?(?:(-?\d{1,9})W)?(?:(-?\d{1,9})D)?(?:T(?:(-?\d{1,9})H)?(?:(-?\d{1,9})M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,9}))?S)?)?)$/;
  function Zt(e) {
    function t(e) {
      return e && f ? -e : e;
    }
      ...
      (e.normalize = function() {
        ...
        return (
          ...
          ln.reduce(function(e, t) {
            return P(r[t]) ? e : (e && dn(n, r, e, r, t), t);
          }, null),
          fn(this, { values: e }, !0)
        );
      }),
            ...
            (function(e) {
              ...
              if (isNaN(t)) {
                ...
                for (var n = 0; n < e.length; n++) {
                  ...
                  if (-1 !== e[n].search(kn.hanidec)) t += Sn.indexOf(e[n]);
                  else
                    for (var i in Tn) {
                      var o = Tn[i],
                        a = o[0],
  ...
  var En = "( |" + String.fromCharCode(160) + ")",
    Nn = new RegExp(En, "g");
  function Dn(e) {
    return e.replace(/\./g, "\\.?").replace(Nn, En);
  }
  function In(e) {
    return e
      .replace(/\./g, "")
  ...
  function zn(t, e, n) {
    ...
    var c,
      ...
      p = y[1],
      g = p
        ? ((l = P((c = p).Z) ? (P(c.z) ? null : Ge.create(c.z)) : new Be(c.Z)),
          P(c.q) || (c.M = 3 * (c.q - 1) + 1),
          P(c.h) || (c.h < 12 && 1 === c.a ? (c.h += 12) : 12 === c.h && 0 === c.a && (c.h = 0)),
          0 === c.G && c.y && (c.y = -c.y),
          P(c.u) || (c.S = oe(c.u)),
          [
  ...
  function Jn(e) {
    var t = e.year;
    return K({ year: t, ordinal: Un(t, e.month, e.day) }, Te(e));
  }
  function Yn(e) {
    var t = e.year,
      n = Rn(t, e.ordinal);
  ...
  var vr = (function() {
    ...
    (I.now = function() {
      ...
      (I.fromObject = function(e) {
        ...
        var w,
          ...
          E =
            (h
              ? ((b = J((S = i).weekYear)),
                (O = te(S.weekNumber, 1, he(S.weekYear))),
                (M = te(S.weekday, 1, 7)),
                b
                  ? O
                    ? !M && qn("weekday", S.weekday)
                    : qn("week", S.week)
                  : qn("weekYear", S.weekYear))
              : o
                ? ((k = J((w = i).year)),
                  (T = te(w.ordinal, 1, le(w.year))),
                  k ? !T && qn("ordinal", w.ordinal) : qn("year", w.year))
                : Gn(i)) || $n(i);
        if (E) return I.invalid(E);
        var N = nr(h ? Wn(i) : o ? Yn(i) : i, r, t),
          D = new I({ ts: N[0], zone: t, o: N[1], loc: l });
      ...
      (I.fromISO = function(e, t) {
        void 0 === t && (t = {});
        var n = wt(e, [Wt, $t], [Jt, Bt], [Yt, Qt], [Gt, Kt]);
    ...
    return (
      ...
      (e.set = function(e) {
        ...
        var t,
          n = we(e, hr, []);
        !P(n.weekYear) || !P(n.weekNumber) || !P(n.weekday)
          ? (t = Wn(K(Pn(this.c), n)))
          : P(n.ordinal)
            ? ((t = K(this.toObject(), n)),
              P(n.day) && (t.day = Math.min(fe(t.year, t.month), t.day)))
            : (t = Yn(K(Jn(this.c), n)));
  ...
  function pr(e) {
    ...
    if (e && e.valueOf && W(e.valueOf())) return vr.fromJSDate(e);
